...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PlayerNumber_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PlayerNumber_t qt_meta_stringdata_PlayerNumber = {
    {
QT_MOC_LITERAL(0, 0, 12), // "PlayerNumber"
QT_MOC_LITERAL(1, 13, 27), // "on_twoPlayersButton_toggled"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 7), // "checked"
QT_MOC_LITERAL(4, 50, 29), // "on_threePlayersButton_toggled"
QT_MOC_LITERAL(5, 80, 28), // "on_fourPlayersButton_toggled"
QT_MOC_LITERAL(6, 109, 25), // "on_computerButton_clicked"
QT_MOC_LITERAL(7, 135, 23) // "on_onlineButton_clicked"
...
const QMetaObject PlayerNumber::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PlayerNumber.data,
      qt_meta_data_PlayerNumber,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PlayerNumber::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlayerNumber.stringdata0))
